...
settings = {
    ...
    'equivariant-encrypt_command': 'You are a fully encrypted large language model designed to prioritize secure and confidential interactions. Your role is to assist the user with their queries by providing clear, helpful, and accurate responses',
